exports.EN = {
  ...
  GALLERY: {
    ...
    CAPTION: 'Caption',
    UPLOAD_PHOTO: 'U p l o a d  p h o t o',
    LIKES: 'likes',
    SEE_ALL: 'See all',
    SEE_MORE: 'Load more',
    ...
    DELETE_PHOTO_BODY: 'Are you sure?',
    DELETE_COMMENT_BODY: 'Are you sure?',
    WARNING: 'Are you sure to delete this photo?',
    WARNING_COMMENT: 'Are you sure to delete this comment?',
    EDIT: 'Edit',
  },
  ASSIGNMENTS_FORM: {
    TITLE: 'New assignment',
    TITLE_EDIT: 'Edit assignment',
    ENTITY: 'Entity',
    ROLE_LIST: 'Role list',
    ROLE: 'Role',
