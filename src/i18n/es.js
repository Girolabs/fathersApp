exports.ES = {
  ...
  AUTH_SCREEN: {
    ...
    SEND: 'Enviar código',
    GO_BACK: 'Volver',
    TOKEN_PLACEHOLDER: 'Código del email',
  ...
  FATHER_DETAIL: {
    ...
    NOVITIATE_START: 'Inicio del nviciado',
  ...
  COURSE: {
    ...
    GENERATION: 'Generación',
    CELEBRATION_DATE: 'Fecha de celebración',
    CONSECRATION_DATE: 'Fecha de consagración del ideal',
    ...
    SION_TIME_MASTER: 'Maestro de Tiempo de Sión',
