exports.PT = {
  GENERAL: {
    ...
    BACK: 'Voltar',
    ERROR_403: 'Você não tem permissão para executar esta ação.',
    ERROR_500: 'Erro desconhecido.',
    ERROR_400: 'Dados inválidos.',
  },
  AUTH_SCREEN: {
  ...
  HOME_SCREEN: {
    ...
    NO_REMINDERS_FOR_DATE: 'Sem lembretes para esta data',
  },
  FATHER_DETAIL: {
    DEATHDATE: 'Data do falecimento',
    LEAVEDATE: 'Saiu da Comunidade',
  ...
  GALLERY: {
    ...
    LIKES: 'Gostei',
    SEE_ALL: 'Veja tudo',
    SEE_MORE: 'Carregue mais',
    SUCCESS: 'Foto postada',
    COMMENT: 'Comente',
    DELETE_PHOTO_TITLE: 'Deletar foto',
    DELETE_COMMENT_TITLE: 'Exclua comentário',
    DELETE_PHOTO_BODY: 'Tem certeza?',
    DELETE_COMMENT_BODY: 'Tem certeza?',
    WARNING: '',
    WARNING_COMMENT: '',
    EDIT: 'Editar',
  },
  ASSIGNMENTS_FORM: {
    TITLE: 'Novo cargo/tarefa',
    TITLE_EDIT: 'Editar cargo/tarefa',
    ENTITY: '',
    ROLE_LIST: '',
    ROLE: 'Função',
    PERSON_LIST: '',
    ...
    ERROR_END_DATE: 'A data de término não pode ser antes da data de início',
    SUCCESS: 'Dados salvos com sucesso',
    WARNING_ASG: '',
    DELETE_TITLE: 'Excluir cargo/tarefa',
    DELETE_BODY: 'Tem certeza?',
  },
  ARCHIVE: {
    ARCHIVE: 'Arquivo',
    ...
    EDIT: 'Editar',
    ARCHIVED: 'Arquivado',
    ERROR: 'Selecione pelo menos uma postagem',
    NO_POSTS: 'Sem postagens arquivadas',
    SUCCESS: 'Dados salvos com sucesso',
  },
};
