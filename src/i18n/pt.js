exports.PT = {
  ...
  AUTH_SCREEN: {
    ...
    SEND: 'Enviar',
    GO_BACK: 'Regressar',
    TOKEN_PLACEHOLDER: 'Token/código',
    EMPTY_IDENTITY: 'Identidade vazia',
    EMPTY_FIELDS: 'Campos vazios',
    ERROR: 'Ocorreu um erro',
    SEND_EMAIL: 'Acabamos de enviar um e-mail para você, lembre-se de verificar também o spam',
  },
  HOME_SCREEN: {
  ...
  LIVING_SITUATION: {
    ...
    FILIATION: ' Filial',
    HOUSE: 'Casa',
    ERROR_END_DATE: 'A data de término não pode ser anterior à data de início',
  },
};
